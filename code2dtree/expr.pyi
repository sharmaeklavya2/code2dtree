...
class Expr:
    ...
    def __pos__(self) -> UnExpr: ...
    def __neg__(self) -> UnExpr: ...
    def __abs__(self) -> UnExpr: ...
    def __round__(self) -> UnExpr: ...
    def __floor__(self) -> UnExpr: ...
    def __ceil__(self) -> UnExpr: ...

    def __add__(self, other: object) -> BinExpr: ...
    def __sub__(self, other: object) -> BinExpr: ...
    def __mul__(self, other: object) -> BinExpr: ...
    def __matmul__(self, other: object) -> BinExpr: ...
    def __truediv__(self, other: object) -> BinExpr: ...
    ...
    def __radd__(self, other: object) -> BinExpr: ...
    def __rsub__(self, other: object) -> BinExpr: ...
    def __rmul__(self, other: object) -> BinExpr: ...
    def __rmatmul__(self, other: object) -> BinExpr: ...
    def __rtruediv__(self, other: object) -> BinExpr: ...
